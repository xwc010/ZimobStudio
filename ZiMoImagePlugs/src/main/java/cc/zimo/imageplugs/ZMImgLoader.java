...
public class ZMImgLoader {

    private final String TAG = ZMImgLoader.class.getSimpleName();
    private IImgAdapter mImgAdapter;
    private static ZMImgLoader mImgLoader;

    private ZMImgLoader(){

    }

    public static ZMImgLoader getInstance(){
        if(mImgLoader == null){
            synchronized (ZMImgLoader.class){
                if(mImgLoader == null){
                    mImgLoader = new ZMImgLoader();
                }
            }
        }
