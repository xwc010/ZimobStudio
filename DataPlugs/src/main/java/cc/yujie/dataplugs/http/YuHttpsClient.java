...
public class YuHttpsClient implements IHttp {
    ...
    private static YuHttpsClient httpsClient;
    private OkHttpClient okHttpClient;

    private YuHttpsClient() {
    ...
    public static YuHttpsClient getInstance() {
        if (httpsClient == null) {
            synchronized (YuHttpsClient.class) {
                if (httpsClient == null) {
                    httpsClient = new YuHttpsClient();
                }
            }
        }
