...
public class DownloadHttpTool {
    ...
    public void start(String urlstr) {
        ...
        fileName = ss[ss.length - 1].replace(".3ex",""); // h.bh(.getBytes());
    ...
    private void ready() {
        if (new File(filePath + "/" + fileName).exists()) {
            downloadComplated.onComplated(urlstr, filePath + "/" + fileName);
            return;
        }
        totalCompelete = 0;
    ...
    private void compeleted() {
        ...
        sqlTool.delete(urlstr);
        downloadComplated.onComplated(urlstr, filePath + File.separator + fileName);
    }
    ...
    interface DownloadComplated {
         ...
         * @param urlString
         */
        void onComplated(String urlString, String filePath);
