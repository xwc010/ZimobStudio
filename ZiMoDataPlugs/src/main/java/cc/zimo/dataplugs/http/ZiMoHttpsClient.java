...
public class ZiMoHttpsClient implements IHttp {
    ...
    private static ZiMoHttpsClient httpsClient;
    private OkHttpClient okHttpClient;

    private ZiMoHttpsClient() {
    ...
    public static ZiMoHttpsClient getInstance() {
        if (httpsClient == null) {
            synchronized (ZiMoHttpsClient.class) {
                if (httpsClient == null) {
                    httpsClient = new ZiMoHttpsClient();
                }
            }
        }
