...
public class YJLFeedTabFragment extends ZMBaseFragment implements TabContract.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ZMLog.i("ZiMoBaseFragment onCreateView");
    ...
    private String mFeedTagUrl = YJLUrls.getTabBarUrl("tabs.json");
...
//            topTabLayout.addTab(topTabLayout.newTab().setText(tab.getName()).setTag(tab));
            YJLFeedFragment pageFragment = new YJLFeedFragment();
