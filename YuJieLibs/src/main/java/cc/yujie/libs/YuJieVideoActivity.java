...
import cc.zimo.sdk.ZiMoBaseActivity;
import cn.jzvd.JZUserAction;
import cn.jzvd.JZUserActionStandard;
import cn.jzvd.JZVideoPlayer;
import cn.jzvd.JZVideoPlayerStandard;

public class YuJieVideoActivity extends ZiMoBaseActivity {
    ...
    public static void startVideo(Context context, Feed feed) {
        Intent intent = new Intent(context, YuJieVideoActivity.class);
    ...
    public void initUI() {
        ...
        ZiMoLog.d("YuJieVideo URL: " + YuJieUrls.getVideoUrl(feed.getLink()));
        videoPlayer.setUp(YuJieUrls.getVideoUrl("2222.mp4")
                , JZVideoPlayerStandard.SCREEN_WINDOW_NORMAL, feed.getTitle());

        ZiMoImgLoader.getInstance().loadImg(YuJieUrls.getThumbnailUrl(feed.getId() + "/" + feed.getThumbnail()), videoPlayer.thumbImageView);
